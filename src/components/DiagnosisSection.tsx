...
import { ArrowRight, PiggyBank, TrendingUp, Lightbulb, BookOpen } from "lucide-react";
...
const DiagnosisSection = () => {
  ...
  return (
    <section id="diagnosis" className="py-20 bg-gradient-to-b from-slate-50 to-white">
          ...
          >
            ...
            <CardContent className="text-center px-8 pb-8 relative z-10">
              ...
              <Button 
                ...
                onClick={() => navigate('/diagnosis/mbti')}
                tabIndex={0}
                aria-label="MBTI 진단하기"
              >
                진단하기
